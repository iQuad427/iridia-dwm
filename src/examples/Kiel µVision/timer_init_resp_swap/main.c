...
Troubleshooting :
	...
	- Apparently printing null values (or set to unallocated value can cause program to crash)
		- Happens even if the print won't ever be used
		- Just erase the print, the value can live without creating trouble
			- Can't understand why it happens, it shouldn't
